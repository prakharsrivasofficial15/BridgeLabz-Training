...
{
    internal class AddressBookUtilityImpl : IAddressBook<ContactImpl, int>
    {
        ...
        private readonly IDataSource<ContactImpl> csvDataSource = new CsvDataSource<ContactImpl>();

        private readonly IDataSource<ContactImpl> jsonDataSource = new JsonDataSource<ContactImpl>();

        private readonly IDataSource<ContactImpl> databaseDataSource = new DatabaseDataSource<ContactImpl>("Server=.Database=AddressBookDB;Trusted_Connection=True;");
        ...
        public void SaveToCsv()
        {
            ...
            activeBook.SaveToFile(csvDataSource, path);
        }
        ...
        public void LoadFromCsv()
        {
            ...
            activeBook.LoadFromFile(csvDataSource, path);
        }
        ...
        public void SaveToJson()
        {
            ...
            activeBook.SaveToFile(jsonDataSource, path);
        }
        ...
        public void LoadFromJson()
        {
            ...
            activeBook.LoadFromFile(jsonDataSource, path);
        }
        ...
        public void SaveToDatabase()
        {
            ...
            activeBook.SaveToFile(databaseDataSource, "");
        }
        ...
        public void LoadFromDatabase()
        {
            ...
            activeBook.LoadFromFile(databaseDataSource, "");
        }
        ...
        public void UpdateContactInDatabase()
        {
            ...
            var contact = activeBook.GetContacts()
            ...
            databaseDataSource.Update(contact, "");
        }
