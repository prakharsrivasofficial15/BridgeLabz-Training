...
### 🔹 Overview
Day-2 focused on understanding **version control using Git and GitHub** and how it would be used throughout the training.
...
- Maintaining **daily code commits** during training

### 🔹 Training Workflow Guidance
- Organizing code for daily tasks
- Proper commit message practices
- Managing code changes during the entire training duration
...
## 🗓️ Day-3 | Core C# & .NET Fundamentals

**Date:** 18 December 2025  

### 🔹 Tasks Completed

#### 1️⃣ Code Practice & GitHub Push
- Practiced basic **C# programming problems**
- Pushed **core C# practice code** to GitHub
...
- Understood the internal execution flow of a .NET application
