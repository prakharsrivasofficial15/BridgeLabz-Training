    ...
    internal class AddressBookMenu
    {
        ...
        public void Start()
        {
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    case 1: addressBook.CreateAddressBook(); break;   // UC 5
                    case 2: addressBook.SelectAddressBook(); break;   // UC 5
                    case 3: addressBook.AddContact(); break;          // UC 1,4
                    case 4: addressBook.EditContact(); break;         // UC 2
                    case 5: addressBook.DeleteContact(); break;       // UC 3
                    case 6: addressBook.ShowContacts(); break;        // UC 4
                    case 7: addressBook.SearchByCity(); break;        // UC 8
                    case 8: addressBook.SearchByState(); break;       // UC 8
                    case 9: addressBook.CountByCity(); break;         // UC 9
                    case 10: addressBook.CountByState(); break;       // UC 9
                    case 11: addressBook.SortContactsByName(); break; // UC 10
                    case 12: addressBook.SortContactsByCity(); break; // UC 11
                    case 13: addressBook.SortContactsByState(); break;// UC 11
                    case 14: addressBook.SortContactsByZip(); break;  // UC 11
